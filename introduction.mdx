---
title: 'Introduction'
description: 'ChatHub is an all-in-one AI client that allows you to use multiple AI chatbots side by side. It supports a wide range of AI models, including ChatGPT/GPT-4o, Claude 4, Gemini, Llama, and more. With a single input, ChatHub allows you to receive responses from up to six AI chatbots at once.'
---

## Main Features

- Use multiple AI chatbots [side by side](/features/chat-simultaneously)
- Supports a wide range of [AI models](/cloud/index), including GPT-4o, Claude 4, Gemini, and more
