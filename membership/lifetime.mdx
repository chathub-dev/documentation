...
<Warning>Make sure you're using the ChatHub *browser extension*, not the ChatHub *webapp*!!!</Warning>

![](/images/activation.png)

**Video Tutorial**

<iframe className="w-full aspect-video" src="https://www.youtube.com/embed/B755HMZWp4M?si=QfUHMhxMkemGZnAK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
The license key is sent to the email address you used to purchase the lifetime premium. You should be able to find it in your email inbox.